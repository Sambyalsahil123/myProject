      ...
      <div className="container my-2">
        ...
        <div className="row justify-content-center">
          <div className="col-md-4">
            <div className="card text-white bg-primary mb-3 pt-3 shadow">
              <div className="card-body">
                <input onChange={(e) => setVal(e.target.value)} type="text" className='form-control form-control-lg mb-4 text-center bg-light fs-4 text-primary shadow' value={val} />

                <div className="row mt-3 mx-1 m-4">
